All instructions for CS5242 Assignment 2 is in ‘CS5242_Assignment_2.pdf’.
For Python users, you can use the IPython notebook and the helper functions to code.
We strongly recommend you to use the IPython notebook as it provides means to check
your code and gives helper function to put your code together.
For non-Python users, you can use the pdf and accompanying python function APIs to know what is expected of the submission.
